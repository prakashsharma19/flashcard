...
<body>
    ...
    <script>
        ...
        function flipCard() {
            document.getElementById("flashcard").textContent = showAntonym ? currentFlashcard.word : currentFlashcard.antonym;
